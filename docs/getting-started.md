...
In `openminion-eval`, scope is optional but recommended when it improves owner
clarity, for example `routing`, `policy`, `reporting`, `skills`, `tools`,
`freshness`, `docs`, or `release`.
